export const products = [
  {
    ...
    slug: "notion-note",
    quote:
      "O Notion Note ou NN é um produto desenvolvido para servir de anotação, com ele você pode ter centralizado um uma única plataforma tarefas que você sabe que precisam ser feita mas não quer esquecer.",
  ...
  },
  {
    ...
    slug: "tasks-x",
    quote:
      "O TasksX ou TX é um produto desenvolvido com um protótipo semelhante ao NN, mas feito com múltiplas funcionalidades a mais para servir uma empresa com diversos funcionários e setores. Com o TX você pode ter em mãos todo o controle de tarefas e prazos de seus colaboradores.",
    type: "Produto empresarial",
    imageBanner:
      "https://images.unsplash.com/photo-1483982258113-b72862e6cff6?q=80&w=3456&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    content: [
      {
